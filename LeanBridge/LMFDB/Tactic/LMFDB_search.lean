...
import LeanBridge.LMFDB.NumberFields.LMFDB_Proof_2_2_13_1
...
elab "#LMFDB_search" degree:num r2:num D_abs:num : command => do
  ...
  let python_query_path := "LeanBridge/LMFDB/Tactic/lmfdb_query.py"
  ...
  let module_prefix := "LeanBridge.LMFDB.NumberFields"
